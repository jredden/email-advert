...
/*
	to use:
	to save test:
		bash> php -q run_text_and_image_00.php > eblast-12-22-2009.eml
	to send test:
		bash> php -q run_text_and_image_00.php send
*/
require_once("classes/phpmailer.php");
include "define_text_and_image_vars_00.php";
...
$mailer->AddEmbeddedImage("header_00.jpg","header", "", "base64", "image/jpg");
$mailer->AddEmbeddedImage("footer_00.jpg","bottom", "", "base64", "image/jpg");
