...
public class PrimaryUserPromoteController implements Controller {
	
	public static final String MAIN_USER_PROMOTE = "main_user_promote";
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (session.getAttribute("userName") == null
			...
			_model_and_view.setViewName("/" + MAIN_USER_PROMOTE);
		}
