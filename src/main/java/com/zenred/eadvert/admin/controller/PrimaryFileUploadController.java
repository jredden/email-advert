...
public class PrimaryFileUploadController implements Controller {
	
	public static final String MAIN_UPLOAD = "uploadFile";
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (session.getAttribute("userName") == null
			...
			_model_and_view.setViewName("/" + MAIN_UPLOAD);
		}
