...
public class PrimaryMessageDeleteController implements Controller {
	
	public static final String MAIN_DELETE = "main_delete";
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (session.getAttribute("userName") == null
			...
			_model_and_view.setViewName("/" + MAIN_DELETE);
		}
