...
public class PrimaryInterestGroupController implements Controller {
	
	public static final String MAIN_INTEREST = "main_interest_group";
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (session.getAttribute("userName") == null
			...
			_model_and_view.setViewName("/" + MAIN_INTEREST);
		}
