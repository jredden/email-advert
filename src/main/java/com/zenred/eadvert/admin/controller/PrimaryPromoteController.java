...
public class PrimaryPromoteController implements Controller {
	
	public static final String MAIN_PROMOTE = "main_promote";
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if (session.getAttribute("userName") == null
			...
			_model_and_view.setViewName("/" + MAIN_PROMOTE);
		}
